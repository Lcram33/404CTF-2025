...
def load_model(
    # from_: Optional[str] = None, device: t.device = "cpu", dtype: t.dtype = t.bfloat16 # <== modified from original file as I have a GPU, reverse comments if you have only have a CPU
    from_: Optional[str] = None, device: t.device = "cuda", dtype: t.dtype = t.float32
):
    """
